"""
Django settings for aged_heart_dev_104267 project.
...
ROOT_URLCONF = 'aged_heart_dev_104267.urls'
...
WSGI_APPLICATION = 'aged_heart_dev_104267.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_heart_dev_104267 API",
    "DESCRIPTION": "API documentation for aged_heart_dev_104267 App",
    "VERSION": "v1",
}
